---
description: Phase 2 (breathe) — the PRD gap-hunting iteration loop; exits only at zero gaps AND user-declared final.
---

You are in the **prd** phase. Use the `bnb-prd` skill — it defines the full gap-hunting
